            ...
            <DialogContent className="max-w-3xl max-h-[92vh] overflow-y-auto">
              ...
              <div className="space-y-3">
                <div className="grid gap-3 sm:grid-cols-3">
                  <div className="space-y-1 sm:col-span-3"><Label>收件人</Label><Input value={compose.to} onChange={e => setCompose(p => ({ ...p, to: e.target.value }))} placeholder="已开通的站内邮箱，例如 user@example.com" /></div>
        ...
        <div className="grid gap-4 lg:grid-cols-[190px_380px_1fr]">
          <aside className="space-y-2">
            ...
            <Link to="/settings/mail">
              <Button variant="outline" className="w-full justify-start mt-4">邮箱设置</Button>
            </Link>
          </aside>
